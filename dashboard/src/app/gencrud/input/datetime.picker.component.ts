...
export const CUSTOM_INPUT_CONTROL_VALUE_ACCESSOR: any = {
    ...
    useExisting: forwardRef( () => GcDateTimePickerInputComponent ),
    multi: true
};

@Component( {
  // tslint:disable-next-line:component-selector
  selector: 'gc-datetimepicker-input',
...
export class GcDateTimePickerInputComponent extends GcBaseComponent implements OnInit
{
    ...
    ngOnInit()
    {
        ...
        const time: string = this.localDate.toTimeString().substring( 0, 5 );
    ...
    timeChange( event )
    {
        const time: string = event.toString();

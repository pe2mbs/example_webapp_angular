...
export const CUSTOM_INPUT_CONTROL_VALUE_ACCESSOR: any = {
    ...
    useExisting: forwardRef( () => GcDateTimeInputComponent ),
    multi: true
};

@Component( {
  // tslint:disable-next-line:component-selector
  selector: 'gc-datetime-input',
...
export class GcDateTimeInputComponent extends GcBaseComponent implements OnInit
{

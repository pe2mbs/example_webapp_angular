...
let ScreenRoleComponent = class ScreenRoleComponent extends ScreenBaseComponent {
    constructor(route, router, dataService) {
        ...
        this.formGroup = new FormGroup({
            R_ROLE: new FormControl(this.row.R_ROLE || '', [Validators.required, Validators.maxLength(255),]),
...
ScreenRoleComponent = tslib_1.__decorate([
    Component({

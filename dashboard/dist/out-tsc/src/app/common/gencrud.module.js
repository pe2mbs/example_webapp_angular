...
let GenCrudModule = GenCrudModule_1 = class GenCrudModule {
    static forChild() {
        return { ngModule: GenCrudModule_1 };
    }
};
GenCrudModule = GenCrudModule_1 = tslib_1.__decorate([
    NgModule({
        declarations: [
...
export { GenCrudModule };
//# sourceMappingURL=gencrud.module.js.map
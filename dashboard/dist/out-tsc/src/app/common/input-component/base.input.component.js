...
export const CUSTOM_ANIMATIONS_CONTROLE = [trigger('visibilityChanged', [
...
export class PytBaseComponent {
    ...
    ngOnInit() {
        ...
        this.control = this.formGroupDir.control.get(this.formControlName);
        if (this.debug) {
...
tslib_1.__decorate([
    Input()
], PytBaseComponent.prototype, "debug", void 0);
tslib_1.__decorate([
    Input()
], PytBaseComponent.prototype, "error", void 0);
tslib_1.__decorate([
    Input()
], PytBaseComponent.prototype, "id", void 0);
tslib_1.__decorate([
    Input()
], PytBaseComponent.prototype, "placeholder", void 0);
tslib_1.__decorate([
    Input()
], PytBaseComponent.prototype, "formControlName", void 0);
tslib_1.__decorate([
    Input()
], PytBaseComponent.prototype, "readonly", void 0);
tslib_1.__decorate([
    Input()
], PytBaseComponent.prototype, "disabled", void 0);
tslib_1.__decorate([
    Input()
], PytBaseComponent.prototype, "prefix", void 0);
tslib_1.__decorate([
    Input('prefix-type')
], PytBaseComponent.prototype, "prefixType", void 0);
tslib_1.__decorate([
    Input()
], PytBaseComponent.prototype, "suffix", void 0);
tslib_1.__decorate([
    Input('suffix-type')
], PytBaseComponent.prototype, "suffixType", void 0);
tslib_1.__decorate([
    Input()
], PytBaseComponent.prototype, "color", void 0);
tslib_1.__decorate([
    Input()
], PytBaseComponent.prototype, "hint", void 0);

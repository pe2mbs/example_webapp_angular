...
export const CUSTOM_INPUT_CONTROL_VALUE_ACCESSOR = {
    ...
    useExisting: forwardRef(() => PytTimePickerInputComponent),
    multi: true
};
let PytTimePickerInputComponent = class PytTimePickerInputComponent extends PytBaseComponent {
...
PytTimePickerInputComponent = tslib_1.__decorate([
    Component({
        selector: 'pyt-timepicker-input-box',
...
export { PytTimePickerInputComponent };

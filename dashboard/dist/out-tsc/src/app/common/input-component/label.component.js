...
let PytLabelComponent = class PytLabelComponent extends PytBaseComponent {
    constructor(fGD) {
        super(fGD);
        this.pipe = '';
        this.format = '';
...
tslib_1.__decorate([
    Input('pipe')
], PytLabelComponent.prototype, "pipe", void 0);
tslib_1.__decorate([
    Input('format')
], PytLabelComponent.prototype, "format", void 0);
PytLabelComponent = tslib_1.__decorate([
    Component({
